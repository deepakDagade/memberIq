...
@NoArgsConstructor
@Data
public class PaymentDetailsSpecification implements Specification<PaymentDetails> {
	private static final long serialVersionUID = 1L;
	// make static variable
	private FilterCriteria criteria;

	@Override
	public Predicate toPredicate(Root<PaymentDetails> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
