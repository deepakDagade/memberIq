...
public class ExpenseCategorySpecification implements Specification<ExpenseCategory> {
	...
	public ExpenseCategorySpecification(FilterCriteria criteria) {
		this.criteria = criteria;
	}

	@Override
	public Predicate toPredicate(Root<ExpenseCategory> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
