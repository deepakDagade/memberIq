...
@NoArgsConstructor
@Data
public class PaymentModeSpecification implements Specification<PaymentMode> {
	private static final long serialVersionUID = 1L;
	// make static variable
	private FilterCriteria criteria;

	@Override
	public Predicate toPredicate(Root<PaymentMode> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
