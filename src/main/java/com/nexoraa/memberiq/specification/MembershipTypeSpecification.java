...
public class MembershipTypeSpecification implements Specification<MembershipType> {

	private static final long serialVersionUID = 1L;

	private final FilterCriteria criteria;

	public MembershipTypeSpecification(FilterCriteria criteria) {
		this.criteria = criteria;
	}

	@Override
	public Predicate toPredicate(Root<MembershipType> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
